...
Etapa atual: **6** (qualidade / `qa_divergencias`). Etapas **1–5** feitas. Briefing da etapa 5: [etapa_5.md](etapa_5.md). Briefing da etapa 4 (histórico): [etapa_4.md](etapa_4.md).
